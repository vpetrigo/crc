...
#define BINARY_OP(name, op)                                                    \
    ...
    {                                                                          \
        if (!(x op y)) {                                                       \
            ss_ << " failed: Expect:" << std::hex << uint64_t{x}               \
                << (" " #op " ") << "Actual:" << std::hex << uint64_t{y};      \
            ok_ = false;                                                       \
        }                                                                      \
        return *this;                                                          \
    }
...
#define ASSERT_EQ(a, b)                                                        \
    ::common::test::Tester(__FILE__, __LINE__).IsEq((a), (b))
#define ASSERT_NE(a, b)                                                        \
    ::common::test::Tester(__FILE__, __LINE__).IsNe((a), (b))
#define ASSERT_GE(a, b)                                                        \
    ::common::test::Tester(__FILE__, __LINE__).IsGe((a), (b))
#define ASSERT_GT(a, b)                                                        \
    ::common::test::Tester(__FILE__, __LINE__).IsGt((a), (b))
#define ASSERT_LE(a, b)                                                        \
    ::common::test::Tester(__FILE__, __LINE__).IsLe((a), (b))
#define ASSERT_LT(a, b)                                                        \
    ::common::test::Tester(__FILE__, __LINE__).IsLt((a), (b))
...
#define EXPECT_DOUBLE_EQ(a, b)                                                 \
    ::common::test::Tester(__FILE__, __LINE__).IsDoubleEq((a), (b))
#define EXPECT_TRUE(a)                                                         \
    ::common::test::Tester(__FILE__, __LINE__).IsEq((a), (true))
#define EXPECT_FALSE(a)                                                        \
    ::common::test::Tester(__FILE__, __LINE__).IsEq((a), (false))
...
#define TEST(base, name)                                                       \
    ...
    bool TCONCAT(_Test_ignored_, base##name) = ::common::test::RegisterTest(   \
        #base, #name, &TCONCAT(_Test_, base##name)::_RunIt);                   \
