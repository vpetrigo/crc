...
{
    return crc16(reinterpret_cast<const unsigned char *>(key.c_str()),
                 key.size());
}
...
{
    return crc32(reinterpret_cast<const unsigned char *>(key.c_str()),
                 key.size());
}
...
{
    return crc64(reinterpret_cast<const unsigned char *>(key.c_str()),
                 key.size());
}
